...
# Envia pacote: SALT + HMAC + IV + MENSAGEM_CRIPTOGRAFADA
pacote_final = salt + hmac_tag + iv + mensagem_encriptada
cliente.send(pacote_final)
print("[+] Mensagem segura enviada ao servidor.")
